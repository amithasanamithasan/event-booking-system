...
@section('css_content')
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of usering all of them to reduce the load. -->
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-green">
            ...
            <a href="{{ route('admin.event-list') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
            ...
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  <td>{{$i}}</td>
                  <td>{{ $user->name }}</td>
                  <td>{{ App\Category::where(['id'=>$user->org_type_id])->pluck('name')[0] }}</td>
                  <td>{{ $user->email }}</td>
                  <td>{{ $user->phone }}</td>
                  
                  <td><?php if (!empty($user->image)): ?>
                    <img height="50" src="../images/users/{{ $user->image }}">
                  <?php endif ?></td>
                </tr>
                <?php $i++; ?>
                @endforeach
