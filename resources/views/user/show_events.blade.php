            ...
            <div class="box-body table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a class="btn btn-primary btn-sm" href="{{ url('/user/edit-event',$event->id) }}"><i class="fa fa-edit"></i></a>||<a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure delete this post?')" href="{{ url('/user/delete-event',$event->id) }}"><i class="fa fa-trash"></i></a></td>
                </tr>
                <?php $sl++; ?>
                @endforeach
                </tbody>
